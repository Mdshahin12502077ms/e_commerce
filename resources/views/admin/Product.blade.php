...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{asset('requirefile/mdi/css/materialdesignicons.min.css')}}" />
    <link rel="stylesheet" href="{{asset('requirefile/vendors/base/vendor.bundle.base.css')}}" />
    <!-- endinject -->
    <!-- plugin css for this page -->
    <link
      rel="stylesheet"
      href="{{asset('requirefile/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}"
    />
    <!-- endinject -->
    <!-- plugin css for this page -->
  ...
  <body>
                    ...
                    <form class="forms-sample prod_sub" method="post" id="submit_form" action="javascript:void(0)" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        >
                            ...
                            @foreach($subcatData as $d)
                            <option value="{{$d->id}}">{{$d->sub_catName}}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="form-group">
    ...
    <script src="{{asset('requirefile/vendors/chart.js/Chart.min.js')}}"></script>
    <script src="{{asset('requirefile/vendors/datatables.net/jquery.dataTables.js')}}"></script>
    <script src="{{asset('requirefile/vendors/datatables.net-bs4/dataTables.bootstrap4.js')}}"></script>
    ...
    <script src="{{asset('requirefile/js/dashboard.js')}}"></script>
    <script src="{{asset('requirefile/js/data-table.js')}}"></script>
    <script src="{{asset('requirefile/js/jquery.dataTables.js')}}"></script>
    <script src="{{asset('requirefile/js/dataTables.bootstrap4.js')}}"></script>
    <!-- End custom js for this page-->

    <script src="{{asset('requirefile/js/jquery.cookie.js')}}" type="text/javascript"></script>
    ...
    <!-- <script src="{{asset('requirefile/js/product.js')}}"></script> -->
    <script src="{{asset('requirefile/js/product.js')}}"></script>

    <script src="{{asset('requirefile/js/jquery-3.5.1.slim.min.js')}}"></script>
