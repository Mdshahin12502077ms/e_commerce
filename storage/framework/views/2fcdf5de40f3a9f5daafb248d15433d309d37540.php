        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card mx-auto">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> MAIN PRODUCT CATEGORY FORM</h4>
                 
                  <form class="forms-sample" method="post" action="<?php echo e(url('insert /')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                      <label for="exampleInputUsername1">PRODUCT CATEGORY NAME</label>
                      
                      <input type="text" name="cat_name" class="form-control" id="exampleInputUsername1" placeholder="ENTER PRODUCT CATEGORY NAME">
                    </div>
             ...
             <DIV CLASS="ROW">
              <div class="col-lg-6 grid-margin stretch-card mx-auto w-100">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">MAIN PRODUCT CATEGORY NAME VIEW</h4>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <?php $__currentLoopData = $catdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td><?php echo e($loop->iteration); ?></td>
                            <td><?php echo e($data->cat_name); ?></td>
                            <td><a href='<?php echo e(url("cat_edit/".$data->id)); ?>'>EDIT</a>
                            <a href='<?php echo e(url("cat_delete/".$data->id)); ?>'>DELETE</a></td>
                          </tr>
...
</html><?php /**PATH C:\xampp\htdocs\e_commerce\resources\views//admin/cat.blade.php ENDPATH**/ ?>