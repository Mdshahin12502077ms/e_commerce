                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="{{url('update /')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="cat_name" value="{{$cat_data[0]['cat_name']}}" class="form-control" id="exampleInputUsername1" placeholder="ENTER PRODUCT CATEGORY NAME">
                        
                    <input type="hidden" name="cat_id" value="{{$cat_data[0]['id']}}" class="form-control" id="exampleInputUsername1" placeholder="ENTER PRODUCT CATEGORY NAME">
                    </div>
