            ...
            <div class="col-md-6 grid-margin stretch-card mx-auto">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="<?php echo e(url('update /')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                      <label for="exampleInputUsername1">PRODUCT CATEGORY NAME</label>
                      
                      <input type="text" name="cat_name" value="<?php echo e($cat_data[0]['cat_name']); ?>" class="form-control" id="exampleInputUsername1" placeholder="ENTER PRODUCT CATEGORY NAME">
                        
                    <input type="hidden" name="cat_id" value="<?php echo e($cat_data[0]['id']); ?>" class="form-control" id="exampleInputUsername1" placeholder="ENTER PRODUCT CATEGORY NAME">
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\e_commerce\resources\views/admin/cat_edit.blade.php ENDPATH**/ ?>